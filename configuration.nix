...

{
  ...
  stylix = {
    ...
    # Jjk Ryomen Sukuna, Red, Mahoraga
    # image = pkgs.fetchurl {
    #   url = "https://w.wallhaven.cc/full/k8/wallhaven-k8zg56.png";
    #  hash = "sha256-H/Rt4No+Vw1kHtvwMNABsvW7EaAg0+qAHli4qTz8LoM=";
    #};
    # JJK Gojo vs Sukuna, Red
    # image = pkgs.fetchurl { url = "https://w.wallhaven.cc/full/85/wallhaven-856k82.png"; hash = "sha256-k718EXAuG/0i47EpagjoC7TMBOa6LbUnr1x6/FCKf4w="; };
    # JJK Sukuna crazy art style
    # image = pkgs.fetchurl { url = "https://w.wallhaven.cc/full/3l/wallhaven-3lew53.jpg"; hash = "sha256-n9xViqk4huwvgOduMsxOkcMcrguLqSlgQAKaKnLCdnU="; };
    # Gojo light
    # image = pkgs.fetchurl { url = "https://w.wallhaven.cc/full/z8/wallhaven-z89jxy.jpg"; hash = "sha256-l4QdSc0sR7QCT3VjhYV57pQZv0jeJ5iPaWFx/GZIliM="; };
    ...
    #image = pkgs.fetchurl {
    #   url = "https://w.wallhaven.cc/full/we/wallhaven-weyypx.jpg";
    #   hash = "sha256-xT5QmcW7AEpCLzXgNyxiRZJuIJ34BzlpjR3amP+ezG8=";
    #};
    # vinland
    #image = pkgs.fetchurl {
    # url = "https://w.wallhaven.cc/full/po/wallhaven-poj76e.png";
    #   hash = "sha256-1EpufjQbEFb6tGAxx7laZVwXOLyo0/rOUUr3Yv3lJ3o=";
    # };
    # jujutsu kaisen (perfect)
		#image = pkgs.fetchurl {
		#  url = "https://w.wallhaven.cc/full/5g/wallhaven-5gpxw3.jpg";
		#  hash = "sha256-PKkHkdZUmCkKSMu4K8VukMpNn7EEHIPwjdA0HN2eYDY=";
		# };
		# vinland saga
		#image = pkgs.fetchurl {
		#url = "https://images7.alphacoders.com/131/thumb-1920-1315627.png";
		#hash = "sha256-REOjlGQnypuJFCZz/vobtJ2+EcT40lk2Y7bJwgYU6Ao=";};
		#};
image = pkgs.fetchurl {
  ...
  # Solar System
  #image = pkgs.fetchurl {
  #  url = "https://w.wallhaven.cc/full/po/wallhaven-pokg2e.png";
  #  hash = "sha256-6wZ/idP9O0NYiQcaMDalFJxwDcELdfAQiHRTApfMzto=";
  # };
  #image = pkgs.fetchurl {
  #		url = ""; };
  #  };
